...
<legend>EDIT PROFILE</legend>                 
  ...
  <input type="text" id="husername" name="husername" onkeyup="checkusername()" onblur="checkusername()" value="<?php echo $husername ?>">
  <span class="error" id="husernameErr"> <?php echo $hnameuserErr;?></span><hr>
  ...
  <input type="text" id="hemail" name="hemail" onkeyup="checkEmail()" onblur="checkEmail()" value="<?php echo $hemail ?>">
  ...
  <input type="tel" id="hphone" name="hphone" pattern="[0-9]{3}[0-9]{8}" onkeyup="checkPhoneNumber()" onblur="checkPhoneNumber()" value="<?php echo $hphone ?>">
...
<label for="hosid">Hospital registration ID :</label>
  <input type="number" id="hosid" name="hosid" onkeyup="checkregistrationid()" onblur="checkregistrationid()" value="<?php echo $hosid?>">
